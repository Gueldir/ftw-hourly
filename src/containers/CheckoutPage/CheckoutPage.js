...
export class CheckoutPageComponent extends Component {
  ...
  handlePaymentIntent(handlePaymentParams) {
    ...
    const orderParams = this.customPricingParams({
      ...
      seats: pageData.bookingData ? pageData.bookingData.quantity : null,
  ...
  */
  ...
  customPricingParams(params) {
    const { bookingStart, bookingEnd, listing, seats, ...rest } = params;
    ...
    const quantity = isNightly
      ...
      : isDaily
      ? minutesBetween(bookingStart, bookingEnd)
