...
// searches.
export const defaultPredictions = (config.maps.search.suggestCurrentSearch
...
/*
  Search auto completion input component
  ...
  See the SearchAutocompleteInput.example.js file for a usage
  example within a form.
*/
class SearchAutocompleteInputImpl extends Component {
  constructor(props) {
    super(props);
...
SearchAutocompleteInputImpl.defaultProps = {
  autoFocus: false,
  closeOnBlur: true,
  rootClassName: null,
  className: null,
...
SearchAutocompleteInputImpl.propTypes = {
  autoFocus: bool,
